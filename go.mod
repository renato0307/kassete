module github.com/renato0307/kassete
...
require (
	...
	github.com/lrstanley/bubblezone v0.0.0-20240723130623-7fd58a7b1f91 // indirect
...
require (
	...
	github.com/charmbracelet/soft-serve v0.8.2
